# <a id="Clockwork_Utilities_FloatExtensions"></a> Class FloatExtensions
...
[FloatExtensions](Clockwork.Utilities.FloatExtensions.md)
...
### <a id="Clockwork_Utilities_FloatExtensions_Ceiled_System_Single_"></a> Ceiled\(float\)
...
### <a id="Clockwork_Utilities_FloatExtensions_Floored_System_Single_"></a> Floored\(float\)
...
### <a id="Clockwork_Utilities_FloatExtensions_Rounded_System_Single_"></a> Rounded\(float\)
