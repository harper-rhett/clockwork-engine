# <a id="Clockwork_UI_HorizontalTextSlider"></a> Class HorizontalTextSlider
...
[HorizontalTextSlider](Clockwork.UI.HorizontalTextSlider.md)
...
### <a id="Clockwork_UI_HorizontalTextSlider__ctor_System_String_"></a> HorizontalTextSlider\(string\)
...
### <a id="Clockwork_UI_HorizontalTextSlider_Font"></a> Font
...
### <a id="Clockwork_UI_HorizontalTextSlider_Slider"></a> Slider

```csharp
public HorizontalSlider Slider { get; }
```
...
### <a id="Clockwork_UI_HorizontalTextSlider_Text"></a> Text
...
### <a id="Clockwork_UI_HorizontalTextSlider_TextElement"></a> TextElement
...
### <a id="Clockwork_UI_HorizontalTextSlider_ValueChanged"></a> ValueChanged
