# <a id="Clockwork_Graphics_RenderTexture"></a> Struct RenderTexture
...
### <a id="Clockwork_Graphics_RenderTexture_Texture"></a> Texture
...
### <a id="Clockwork_Graphics_RenderTexture_EndDrawing"></a> EndDrawing\(\)
