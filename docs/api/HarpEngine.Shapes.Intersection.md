# <a id="HarpEngine_Shapes_Intersection"></a> Class Intersection
...
### <a id="HarpEngine_Shapes_Intersection_CircleInCircle_System_Numerics_Vector2_System_Single_System_Numerics_Vector2_System_Single_"></a> CircleInCircle\(Vector2, float, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_CircleInCircleSquared_System_Numerics_Vector2_System_Single_System_Numerics_Vector2_System_Single_"></a> CircleInCircleSquared\(Vector2, float, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_CircleOnCircle_System_Numerics_Vector2_System_Single_System_Numerics_Vector2_System_Single_"></a> CircleOnCircle\(Vector2, float, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_CircleOnCircleSquared_System_Numerics_Vector2_System_Single_System_Numerics_Vector2_System_Single_"></a> CircleOnCircleSquared\(Vector2, float, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_CircleOnLine_System_Numerics_Vector2_System_Single_System_Numerics_Vector2_System_Numerics_Vector2_"></a> CircleOnLine\(Vector2, float, Vector2, Vector2\)
...
### <a id="HarpEngine_Shapes_Intersection_CircleOnRectangle_System_Numerics_Vector2_System_Single_HarpEngine_Graphics_Rectangle_"></a> CircleOnRectangle\(Vector2, float, Rectangle\)
...
### <a id="HarpEngine_Shapes_Intersection_LineOnLine_System_Numerics_Vector2_System_Numerics_Vector2_System_Numerics_Vector2_System_Numerics_Vector2_"></a> LineOnLine\(Vector2, Vector2, Vector2, Vector2\)
...
### <a id="HarpEngine_Shapes_Intersection_LineOnRectangle_System_Numerics_Vector2_System_Numerics_Vector2_HarpEngine_Graphics_Rectangle_"></a> LineOnRectangle\(Vector2, Vector2, Rectangle\)
...
### <a id="HarpEngine_Shapes_Intersection_PointInCircle_System_Numerics_Vector2_System_Numerics_Vector2_System_Single_"></a> PointInCircle\(Vector2, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_PointInCircleSquared_System_Numerics_Vector2_System_Numerics_Vector2_System_Single_"></a> PointInCircleSquared\(Vector2, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_PointInRectangle_System_Numerics_Vector2_HarpEngine_Graphics_Rectangle_"></a> PointInRectangle\(Vector2, Rectangle\)
...
### <a id="HarpEngine_Shapes_Intersection_PointOnLine_System_Numerics_Vector2_System_Numerics_Vector2_System_Numerics_Vector2_System_Single_"></a> PointOnLine\(Vector2, Vector2, Vector2, float\)
...
### <a id="HarpEngine_Shapes_Intersection_RectangleOnRectangle_HarpEngine_Graphics_Rectangle_HarpEngine_Graphics_Rectangle_"></a> RectangleOnRectangle\(Rectangle, Rectangle\)
...
`rectangleA` [Rectangle](HarpEngine.Graphics.Rectangle.md)

`rectangleB` [Rectangle](HarpEngine.Graphics.Rectangle.md)
