# <a id="Clockwork_UI_HorizontalStackContainer"></a> Class HorizontalStackContainer
...
### <a id="Clockwork_UI_HorizontalStackContainer__ctor"></a> HorizontalStackContainer\(\)

```csharp
public HorizontalStackContainer()
```

### <a id="Clockwork_UI_HorizontalStackContainer__ctor_System_Int32_System_Int32_System_Int32_System_Int32_"></a> HorizontalStackContainer\(int, int, int, int\)

```csharp
public HorizontalStackContainer(int x, int y, int width, int height)
```
...
### <a id="Clockwork_UI_HorizontalStackContainer__ctor_System_Int32_System_Int32_System_Int32_System_Int32_Clockwork_UI_Style_"></a> HorizontalStackContainer\(int, int, int, int, Style\)

```csharp
public HorizontalStackContainer(int x, int y, int width, int height, Style style)
```
...
### <a id="Clockwork_UI_HorizontalStackContainer__ctor_System_Numerics_Vector2_System_Numerics_Vector2_"></a> HorizontalStackContainer\(Vector2, Vector2\)

```csharp
public HorizontalStackContainer(Vector2 position, Vector2 size)
```
...
### <a id="Clockwork_UI_HorizontalStackContainer__ctor_System_Numerics_Vector2_System_Numerics_Vector2_Clockwork_UI_Style_"></a> HorizontalStackContainer\(Vector2, Vector2, Style\)

```csharp
public HorizontalStackContainer(Vector2 position, Vector2 size, Style style)
```
...
### <a id="Clockwork_UI_HorizontalStackContainer_Spacing"></a> Spacing
...
### <a id="Clockwork_UI_HorizontalStackContainer_StretchChildrenWidth"></a> StretchChildrenWidth
...
### <a id="Clockwork_UI_HorizontalStackContainer_OnHeightUpdated"></a> OnHeightUpdated\(\)

```csharp
protected override void OnHeightUpdated()
```

### <a id="Clockwork_UI_HorizontalStackContainer_OnWidthUpdated"></a> OnWidthUpdated\(\)

```csharp
protected override void OnWidthUpdated()
```

### <a id="Clockwork_UI_HorizontalStackContainer_OnXUpdated"></a> OnXUpdated\(\)

```csharp
protected override void OnXUpdated()
```

### <a id="Clockwork_UI_HorizontalStackContainer_OnYUpdated"></a> OnYUpdated\(\)
