# <a id="Clockwork_Graphics_Text_Text"></a> Class Text
...
[Text](Clockwork.Graphics.Text.Text.md)
...
### <a id="Clockwork_Graphics_Text_Text_Draw_System_String_System_Numerics_Vector2_System_Int32_Clockwork_Graphics_Color_"></a> Draw\(string, Vector2, int, Color\)
...
### <a id="Clockwork_Graphics_Text_Text_DrawDebug_System_Int32_Clockwork_Graphics_Color_System_String___"></a> DrawDebug\(int, Color, params string\[\]\)
...
`logs` [string](https://learn.microsoft.com/dotnet/api/system.string)\[\]
...
### <a id="Clockwork_Graphics_Text_Text_MeasureWidth_System_String_System_Int32_"></a> MeasureWidth\(string, int\)
...
### <a id="Clockwork_Graphics_Text_Text_SetLineSpacing_System_Int32_"></a> SetLineSpacing\(int\)
