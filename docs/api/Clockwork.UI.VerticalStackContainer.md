# <a id="Clockwork_UI_VerticalStackContainer"></a> Class VerticalStackContainer
...
### <a id="Clockwork_UI_VerticalStackContainer__ctor"></a> VerticalStackContainer\(\)

```csharp
public VerticalStackContainer()
```

### <a id="Clockwork_UI_VerticalStackContainer__ctor_System_Int32_System_Int32_System_Int32_System_Int32_"></a> VerticalStackContainer\(int, int, int, int\)

```csharp
public VerticalStackContainer(int x, int y, int width, int height)
```
...
### <a id="Clockwork_UI_VerticalStackContainer__ctor_System_Int32_System_Int32_System_Int32_System_Int32_Clockwork_UI_Style_"></a> VerticalStackContainer\(int, int, int, int, Style\)

```csharp
public VerticalStackContainer(int x, int y, int width, int height, Style style)
```
...
### <a id="Clockwork_UI_VerticalStackContainer__ctor_System_Numerics_Vector2_System_Numerics_Vector2_"></a> VerticalStackContainer\(Vector2, Vector2\)

```csharp
public VerticalStackContainer(Vector2 position, Vector2 size)
```
...
### <a id="Clockwork_UI_VerticalStackContainer__ctor_System_Numerics_Vector2_System_Numerics_Vector2_Clockwork_UI_Style_"></a> VerticalStackContainer\(Vector2, Vector2, Style\)

```csharp
public VerticalStackContainer(Vector2 position, Vector2 size, Style style)
```
...
### <a id="Clockwork_UI_VerticalStackContainer_Spacing"></a> Spacing
...
### <a id="Clockwork_UI_VerticalStackContainer_StretchChildrenHeight"></a> StretchChildrenHeight
...
### <a id="Clockwork_UI_VerticalStackContainer_OnHeightUpdated"></a> OnHeightUpdated\(\)

```csharp
protected override void OnHeightUpdated()
```

### <a id="Clockwork_UI_VerticalStackContainer_OnWidthUpdated"></a> OnWidthUpdated\(\)

```csharp
protected override void OnWidthUpdated()
```

### <a id="Clockwork_UI_VerticalStackContainer_OnXUpdated"></a> OnXUpdated\(\)

```csharp
protected override void OnXUpdated()
```

### <a id="Clockwork_UI_VerticalStackContainer_OnYUpdated"></a> OnYUpdated\(\)
