# <a id="Clockwork_Windowing_Window"></a> Class Window
...
### <a id="Clockwork_Windowing_Window_Height"></a> Height
...
### <a id="Clockwork_Windowing_Window_Close"></a> Close\(\)
...
### <a id="Clockwork_Windowing_Window_Initialize_System_Int32_System_Int32_System_String_"></a> Initialize\(int, int, string\)
...
### <a id="Clockwork_Windowing_Window_SetBorderless_System_Boolean_"></a> SetBorderless\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetFullscreen_System_Boolean_"></a> SetFullscreen\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetIcon_Clockwork_Graphics_Image_"></a> SetIcon\(Image\)
...
### <a id="Clockwork_Windowing_Window_SetIcons_Clockwork_Graphics_Image__System_Int32_"></a> SetIcons\(Image\*, int\)
...
`images` [Image](Clockwork.Graphics.Image.md)\*

`count` [int](https://learn.microsoft.com/dotnet/api/system.int32)

### <a id="Clockwork_Windowing_Window_SetMSAA4x_System_Boolean_"></a> SetMSAA4x\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetMaximized_System_Boolean_"></a> SetMaximized\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetMinimized_System_Boolean_"></a> SetMinimized\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetTitle_System_String_"></a> SetTitle\(string\)
...
### <a id="Clockwork_Windowing_Window_SetUndecorated_System_Boolean_"></a> SetUndecorated\(bool\)
...
### <a id="Clockwork_Windowing_Window_SetVsync_System_Boolean_"></a> SetVsync\(bool\)
