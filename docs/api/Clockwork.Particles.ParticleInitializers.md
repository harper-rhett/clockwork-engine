# <a id="Clockwork_Particles_ParticleInitializers"></a> Class ParticleInitializers
...
[ParticleInitializers](Clockwork.Particles.ParticleInitializers.md)
...
### <a id="Clockwork_Particles_ParticleInitializers_AddVelocity_System_Numerics_Vector2_"></a> AddVelocity\(Vector2\)
...
#### Returns
 ...
 [Particle2DInitializer](Clockwork.Particles.Particle2DInitializer.md)

### <a id="Clockwork_Particles_ParticleInitializers_ClearVelocity"></a> ClearVelocity\(\)
...
### <a id="Clockwork_Particles_ParticleInitializers_ConicDirection_System_Numerics_Vector2_System_Single_"></a> ConicDirection\(Vector2, float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_OverrideGradient_Clockwork_Graphics_Gradient_"></a> OverrideGradient\(Gradient\)
...
`gradient` [Gradient](Clockwork.Graphics.Gradient.md)

#### Returns

 [Particle2DInitializer](Clockwork.Particles.Particle2DInitializer.md)

### <a id="Clockwork_Particles_ParticleInitializers_OverrideLifespan_System_Single_"></a> OverrideLifespan\(float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_OverridePosition_System_Numerics_Vector2_"></a> OverridePosition\(Vector2\)
...
### <a id="Clockwork_Particles_ParticleInitializers_OverrideRotation_System_Single_"></a> OverrideRotation\(float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_OverrideRotationSpeed_System_Single_"></a> OverrideRotationSpeed\(float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_OverrideVelocity_System_Numerics_Vector2_"></a> OverrideVelocity\(Vector2\)
...
### <a id="Clockwork_Particles_ParticleInitializers_RandomizeDirection"></a> RandomizeDirection\(\)
...
### <a id="Clockwork_Particles_ParticleInitializers_RandomizeLifespan_System_Single_System_Single_"></a> RandomizeLifespan\(float, float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_RandomizeRotation"></a> RandomizeRotation\(\)
...
### <a id="Clockwork_Particles_ParticleInitializers_RandomizeRotationSpeed_System_Single_System_Single_"></a> RandomizeRotationSpeed\(float, float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_RandomizeSpeed_System_Single_System_Single_"></a> RandomizeSpeed\(float, float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_Scatter_System_Single_"></a> Scatter\(float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_ScatterByDirection_System_Single_"></a> ScatterByDirection\(float\)
...
### <a id="Clockwork_Particles_ParticleInitializers_SetColor_Clockwork_Graphics_Color_"></a> SetColor\(Color\)
...
### <a id="Clockwork_Particles_ParticleInitializers_SetColors_Clockwork_Graphics_Color___"></a> SetColors\(params Color\[\]\)
...
### <a id="Clockwork_Particles_ParticleInitializers_SetSpeed_System_Single_"></a> SetSpeed\(float\)
