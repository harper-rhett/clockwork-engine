# <a id="Clockwork_Audio_MusicRepeater"></a> Class MusicRepeater
...
### <a id="Clockwork_Audio_MusicRepeater__ctor_Clockwork_Audio_Music_"></a> MusicRepeater\(Music\)
...
### <a id="Clockwork_Audio_MusicRepeater_OnUpdate"></a> OnUpdate\(\)

```csharp
public override void OnUpdate()
```

### <a id="Clockwork_Audio_MusicRepeater_Pause"></a> Pause\(\)

```csharp
public void Pause()
```

### <a id="Clockwork_Audio_MusicRepeater_Resume"></a> Resume\(\)

```csharp
public void Resume()
```

### <a id="Clockwork_Audio_MusicRepeater_Start"></a> Start\(\)

```csharp
public void Start()
```

### <a id="Clockwork_Audio_MusicRepeater_Stop"></a> Stop\(\)
