...
public static class Primitives3D
{
	...
	public static void DrawCube(Vector3 position, float size, Color color) => backend.DrawCube(position, size, color);
	public static void DrawCubeWires(Vector3 position, float size, Color color) => backend.DrawCubeWires(position, size, color);

	public static void DrawBox(Vector3 position, float width, float height, float length, Color color) => backend.DrawBox(position, width, height, length, color);
	public static void DrawBox(Vector3 position, Vector3 size, Color color) => backend.DrawBox(position, size, color);
	public static void DrawBoxWires(Vector3 position, float width, float height, float length, Color color) => backend.DrawBoxWires(position, width, height, length, color);
	public static void DrawBoxWires(Vector3 position, Vector3 size, Color color) => backend.DrawBoxWires(position, size, color);
