...
public unsafe struct Texture : IDisposable
{
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "LoadTextureFromImage")]
	public static extern Texture Load(Image image);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsTextureValid")]
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern bool IsThisValid(Texture texture);
	public bool IsValid => IsThisValid(this);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "UnloadTexture")]
	private static extern void Unload(Texture texture);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetTextureFilter")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTexture")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTextureRec")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTexturePro")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTextureNPatch")]
