...
public unsafe struct ShaderData : IDisposable
{
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "BeginShaderMode")]
	public static extern void BeginUsing(ShaderData shaderData);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "EndShaderMode")]
	public static extern void EndUsing();

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "LoadShader")]
	public static extern ShaderData LoadFromFile(string vertexFileName, string fragmentFileName);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "LoadShaderFromMemory")]
	public static extern ShaderData LoadFromCode(string vertexCode, string fragmentCode);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsShaderValid")]
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern bool IsThisValid(ShaderData shaderData);
	public bool IsValid => IsThisValid(this);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "GetShaderLocation")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetShaderValue")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetShaderValueV")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetShaderValueMatrix")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetShaderValueTexture")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "UnloadShader")]
