...
public static class Primitives2D
{
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawPixel")]
	public static extern void DrawPixel(int x, int y, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawPixelV")]
	public static extern void DrawPixel(Vector2 position, Color color);

	// Lines

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawLine")]
	public static extern void DrawLine(int startX, int startY, int endX, int endY, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawLineV")]
	public static extern void DrawLine(Vector2 startPosition, Vector2 endPosition, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawLineEx")]
	public static extern void DrawLine(Vector2 startPosition, Vector2 endPosition, float thickness, Color color);
	public static void DrawLine(int startX, int startY, int endX, int endY, float thickness, Color color) => DrawLine(new Vector2(startX, startY), new Vector2(endX, endY), thickness, color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawLineStrip")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawLineBezier")]
	public static extern void DrawBezier(Vector2 startPosition, Vector2 endPosition, float thickness, Color color);

	// Circles

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawCircle")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawCircleGradient")]
	public static extern void DrawCircle(int x, int y, float radius, Color innerColor, Color outerColor);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawCircleV")]
	public static extern void DrawCircle(Vector2 position, float radius, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawCircleLines")]
	public static extern void DrawCircleLines(int x, int y, float radius, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawCircleLinesV")]
	public static extern void DrawCircleLines(Vector2 position, float radius, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawEllipse")]
	public static extern void DrawEllipse(int x, int y, float horizontalRadius, float verticalRadius, Color color);
	public static void DrawEllipse(Vector2 position, float horizontalRadius, float verticalRadius, Color color) => DrawEllipse((int)position.X, (int)position.Y, horizontalRadius, verticalRadius, color);
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangle")]
	public static extern void DrawRectangle(int x, int y, int width, int height, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleV")]
	public static extern void DrawRectangle(Vector2 position, Vector2 size, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleRec")]
	public static extern void DrawRectangle(Rectangle rectangle, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectanglePro")]
	...
	public static void DrawSquare(Vector2 position, int size, Color color) => DrawRectangle((int)position.X, (int)position.Y, size, size, color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleGradientV")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleGradientH")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleGradientEx")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleLines")]
	public static extern void DrawRectangleLines(int x, int y, int width, int height, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleLinesEx")]
	public static extern void DrawRectangleLines(Rectangle rectangle, float lineThickness, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleRounded")]
	public static extern void DrawRectangleRounded(Rectangle rectangle, float roundness, int segments, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleRoundedLines")]
	public static extern void DrawRectangleRoundedLines(Rectangle rectangle, float roundness, int segments, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawRectangleRoundedLinesEx")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTriangle")]
	public static extern void DrawTriangle(Vector2 cornerOne, Vector2 cornerTwo, Vector2 cornerThree, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTriangleLines")]
	public static extern void DrawTriangleLines(Vector2 cornerOne, Vector2 cornerTwo, Vector2 cornerThree, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTriangleFan")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawTriangleStrip")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawPoly")]
	public static extern void DrawPolygon(Vector2 position, int sides, float radius, float rotation, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawPolyLines")]
	public static extern void DrawPolygonLines(Vector2 position, int sides, float radius, float rotation, Color color);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "DrawPolyLinesEx")]
