...
public class Gamepad
{
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsGamepadAvailable")]
	[return: MarshalAs(UnmanagedType.I1)]
	private static extern bool IsAvailable(int gamepadIndex);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "GetGamepadName")]
	private static extern string GetName(int gamepadIndex);
	public string Name => GetName(index);

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsGamepadButtonPressed")]
	[return: MarshalAs(UnmanagedType.I1)]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsGamepadButtonDown")]
	[return: MarshalAs(UnmanagedType.I1)]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "IsGamepadButtonReleased")]
	[return: MarshalAs(UnmanagedType.I1)]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "GetGamepadButtonPressed")]
	private static extern GamepadButton GetButtonPressed();
	public GamepadButton LastButtonPressed => GetButtonPressed();

	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "GetGamepadAxisMovement")]
	...
	[DllImport(Engine.raylibLibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "SetGamepadVibration")]
